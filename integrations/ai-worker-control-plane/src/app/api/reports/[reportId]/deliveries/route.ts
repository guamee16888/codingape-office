...
import { listReportDeliveries } from "../../../../../lib/report-delivery.mjs";
...
export async function GET(
  ...
  try {
    ...
    const deliveries = listReportDeliveries(reportId);

    return Response.json({ report_id: reportId, deliveries }, { status: 200 });
  } catch (error) {
